					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="index.php#tshirt" data-toggle="tab">T-Shirt</a></li>
								<li><a href="index.php#blazers" data-toggle="tab">Blazers</a></li>
								<li><a href="index.php#sunglass" data-toggle="tab">Sunglass</a></li>
								<li><a href="index.php#kids" data-toggle="tab">Kids</a></li>
								<li><a href="index.php#poloshirt" data-toggle="tab">Polo shirt</a></li>
							</ul>
						</div>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>Service</h2>
							<ul class="nav nav-pills nav-stacked">
								<li><a href="index.php#">Online Help</a></li>
								<li><a href="index.php#">Contact Us</a></li>
								<li><a href="index.php#">Order Status</a></li>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="index.php#">Womens</a></li>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="index.php#">Privecy Policy</a></li>
								<li><a href="index.php#">Refund Policy</a></li>
								<li><a href="index.php#">Billing System</a></li>
								<li><a href="index.php#">Ticket System</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>About Shopper</h2>
							<ul class="nav nav-pills nav-stacked">
								<li><a href="index.php#">Company Information</a></li>
								<li><a href="index.php#">Careers</a></li>
								<li><a href="index.php#">Store Location</a></li>
								<li><a href="index.php#">Affillate Program</a></li>
								<li><a href="index.php#">Copyright</a></li>
							</ul>
						</div>
					</div>
