					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="<?php echo $root?>index.php" class="active">Home</a></li>
								<li class="dropdown"><a href="index.php#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?php echo $root?>shop.php">Products</a></li>
										<li><a href="<?php echo $root?>product-details.php">Product Details</a></li> 
										<li><a href="<?php echo $root?>checkout.php">Checkout</a></li> 
										<li><a href="<?php echo $root?>cart.php">Cart</a></li> 
										<li><a href="<?php echo $root?>login.php">Login</a></li> 
                                    </ul>
                                </li> 
								<li class="dropdown"><a href="index.php#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?php echo $root?>blog.php">Blog List</a></li>
										<li><a href="<?php echo $root?>blog-single.php">Blog Single</a></li>
                                    </ul>
                                </li> 
								<li><a href="<?php echo $root?>404.php">404</a></li>
								<li><a href="<?php echo $root?>contact-us.php">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
